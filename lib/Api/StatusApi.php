...
class StatusApi
{
     ...
     * @return \Kaufland\Seller\Model\ApiResponsePingMessage_
     */
     ...
     * @throws \Kaufland\Seller\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Kaufland\Seller\Model\ApiResponsePingMessage_, HTTP status code, HTTP response headers (array of strings)
     */
    public function pingWithHttpInfo()
    {
        $returnType = '\Kaufland\Seller\Model\ApiResponsePingMessage_';
