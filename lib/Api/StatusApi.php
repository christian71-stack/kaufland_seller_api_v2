...
class StatusApi
{
     ...
     * @return \Cbdesk\Kauflandv2\Api\Model\ApiResponsePingMessage_
     */
     ...
     * @throws \Cbdesk\Kauflandv2\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cbdesk\Kauflandv2\Api\Model\ApiResponsePingMessage_, HTTP status code, HTTP response headers (array of strings)
     */
    public function pingWithHttpInfo()
    {
        $returnType = '\Cbdesk\Kauflandv2\Api\Model\ApiResponsePingMessage_';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cbdesk\Kauflandv2\Api\Model\ApiResponsePingMessage_',
