...
class CarriersApi
{
     ...
     * @return \Cbdesk\Kauflandv2\Api\Model\ApiResponseCarriers_
     */
    public function getCarriers()
    {
        list($response) = $this->getCarriersWithHttpInfo();
        return $response;
    }
     ...
     * @throws \Cbdesk\Kauflandv2\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cbdesk\Kauflandv2\Api\Model\ApiResponseCarriers_, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCarriersWithHttpInfo()
    {
        $returnType = '\Cbdesk\Kauflandv2\Api\Model\ApiResponseCarriers_';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cbdesk\Kauflandv2\Api\Model\ApiResponseCarriers_',
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCarriersAsyncWithHttpInfo()
    {
        $returnType = '\Cbdesk\Kauflandv2\Api\Model\ApiResponseCarriers_';
        $request = $this->getCarriersRequest();
